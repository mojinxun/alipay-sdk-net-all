...
public class ApiFitnessMerchantFinishConfirmRequest : IAopRequest<ApiFitnessMerchantFinishConfirmResponse>
{
    ...
    public string GetApiName() => "api.fitness.merchantFinishConfirm";
