...
public class ApiFitnessProductUpdateOnlineParamRequest : IAopRequest<ApiFitnessProductUpdateOnlineParamResponse>
{
    ...
    public string GetApiName() => "api.fitness.product.updateOnlineParam";
