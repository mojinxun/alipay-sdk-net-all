...
public class ApiFitnessMerchantApplyInfoQueryRequest : IAopRequest<ApiFitnessMerchantApplyInfoQueryResponse>
{
    ...
    public string GetApiName() => "api.fitness.merchantApplyInfoQuery";
