...
public class ApiFitnessSubscriptionPostponeRequest : IAopRequest<ApiFitnessSubscriptionPostponeResponse>
{
    ...
    public string GetApiName() => "api.fitness.subscriptionPostpone";
