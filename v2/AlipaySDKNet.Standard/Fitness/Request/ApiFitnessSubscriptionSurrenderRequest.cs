...
/// ∂©π∫Ω‚‘º
/// </summary>
public class ApiFitnessSubscriptionSurrenderRequest : IAopRequest<ApiFitnessSubscriptionSurrenderResponse>
{
    ...
    public string GetApiName() => "api.fitness.subscriptionSurrender";
