...
public class AlipayPlanetTaskRedPacketMngOpenApiUserQueryStatusRequest : IAopRequest<AlipayPlanetTaskRedPacketMngOpenApiUserQueryStatusResponse>
{
    ...
    public string GetApiName() => "alipay.planet.taskRedPacketMng.openApi.user.queryStatus";
