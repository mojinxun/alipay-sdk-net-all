...
public class AlipayPlanetTaskRedPacketMngOpenApiTaskQueryDetailRequest : IAopRequest<AlipayPlanetTaskRedPacketMngOpenApiTaskQueryDetailResponse>
{
    ...
    public string GetApiName() => "alipay.planet.taskRedPacketMng.openApi.task.queryDetail";
