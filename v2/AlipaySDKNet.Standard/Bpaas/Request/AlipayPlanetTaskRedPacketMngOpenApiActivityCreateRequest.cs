...
public class AlipayPlanetTaskRedPacketMngOpenApiActivityCreateRequest : IAopRequest<AlipayPlanetTaskRedPacketMngOpenApiActivityCreateResponse>
{
    ...
    public string GetApiName() => "alipay.planet.taskRedPacketMng.openApi.activity.create";
