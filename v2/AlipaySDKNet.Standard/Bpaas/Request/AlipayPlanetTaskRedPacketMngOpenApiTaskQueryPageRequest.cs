...
public class AlipayPlanetTaskRedPacketMngOpenApiTaskQueryPageRequest : IAopRequest<AlipayPlanetTaskRedPacketMngOpenApiTaskQueryPageResponse>
{
    ...
    public string GetApiName() => "alipay.planet.taskRedPacketMng.openApi.task.queryPage";
