...
public class AlipayPlanetTaskRedPacketMngOpenApiEquitySaveRequest : IAopRequest<AlipayPlanetTaskRedPacketMngOpenApiEquitySaveResponse>
{
    ...
    public string GetApiName() => "alipay.planet.taskRedPacketMng.openApi.equity.save";
