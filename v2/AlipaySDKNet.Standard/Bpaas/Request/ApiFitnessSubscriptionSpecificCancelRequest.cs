...
/// 指定期数取消
/// </summary>
public class ApiFitnessSubscriptionSpecificCancelRequest : IAopRequest<ApiFitnessSubscriptionSpecificCancelResponse>
{
    ...
    public string GetApiName() => "api.fitness.subscriptionSpecificCancel";
