...
public class ApiFitnessProductSaveOrUpdateRequest : IAopRequest<ApiFitnessProductSaveOrUpdateResponse>
{
    ...
    public string GetApiName() => "api.fitness.product.saveOrUpdate";
