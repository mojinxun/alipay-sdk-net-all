...
public class AlipayPlanetTaskRedPacketMngOpenApiTaskDeleteRequest : IAopRequest<AlipayPlanetTaskRedPacketMngOpenApiTaskDeleteResponse>
{
    ...
    public string GetApiName() => "alipay.planet.taskRedPacketMng.openApi.task.delete";
