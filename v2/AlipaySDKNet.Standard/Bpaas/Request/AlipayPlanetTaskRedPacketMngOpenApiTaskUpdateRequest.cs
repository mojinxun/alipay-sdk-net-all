...
public class AlipayPlanetTaskRedPacketMngOpenApiTaskUpdateRequest : IAopRequest<AlipayPlanetTaskRedPacketMngOpenApiTaskUpdateResponse>
{
    ...
    public string GetApiName() => "alipay.planet.taskRedPacketMng.openApi.task.update";
