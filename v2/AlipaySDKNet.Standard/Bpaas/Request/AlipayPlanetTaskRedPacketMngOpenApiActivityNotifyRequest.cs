...
public class AlipayPlanetTaskRedPacketMngOpenApiActivityNotifyRequest : IAopRequest<AlipayPlanetTaskRedPacketMngOpenApiActivityNotifyResponse>
{
    ...
    public string GetApiName() => "alipay.planet.taskRedPacketMng.openApi.activity.notify";
