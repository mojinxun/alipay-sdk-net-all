...
public class AlipayPlanetTaskRedPacketMngOpenApiEquityQueryPageRequest : IAopRequest<AlipayPlanetTaskRedPacketMngOpenApiEquityQueryPageResponse>
{
    ...
    public string GetApiName() => "alipay.planet.taskRedPacketMng.openApi.equity.queryPage";
