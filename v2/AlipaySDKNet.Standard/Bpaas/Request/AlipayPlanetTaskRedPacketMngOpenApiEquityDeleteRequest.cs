...
public class AlipayPlanetTaskRedPacketMngOpenApiEquityDeleteRequest : IAopRequest<AlipayPlanetTaskRedPacketMngOpenApiEquityDeleteResponse>
{
    ...
    public string GetApiName() => "alipay.planet.taskRedPacketMng.openApi.equity.delete";
