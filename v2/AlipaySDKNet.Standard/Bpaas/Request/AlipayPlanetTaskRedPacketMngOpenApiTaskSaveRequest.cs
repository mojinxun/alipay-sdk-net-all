...
public class AlipayPlanetTaskRedPacketMngOpenApiTaskSaveRequest : IAopRequest<AlipayPlanetTaskRedPacketMngOpenApiTaskSaveResponse>
{
    ...
    public string GetApiName() => "alipay.planet.taskRedPacketMng.openApi.task.save";
