...
public class ApiFitnessSubscriptionRegainRequest : IAopRequest<ApiFitnessSubscriptionRegainResponse>
{
    ...
    public string GetApiName() => "api.fitness.subscriptionRegain";
