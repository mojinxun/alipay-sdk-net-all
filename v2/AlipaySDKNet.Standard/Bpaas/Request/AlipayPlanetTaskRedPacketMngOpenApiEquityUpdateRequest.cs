...
public class AlipayPlanetTaskRedPacketMngOpenApiEquityUpdateRequest : IAopRequest<AlipayPlanetTaskRedPacketMngOpenApiEquityUpdateResponse>
{
    ...
    public string GetApiName() => "alipay.planet.taskRedPacketMng.openApi.equity.update";
