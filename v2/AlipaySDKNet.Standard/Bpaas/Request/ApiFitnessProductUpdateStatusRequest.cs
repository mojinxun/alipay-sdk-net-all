...
public class ApiFitnessProductUpdateStatusRequest : IAopRequest<ApiFitnessProductUpdateStatusResponse>
{
    ...
    public string GetApiName() => "api.fitness.product.updateStatus";
